...
const FavBook = () => {
  return (
    <section className='flex flex-col md:flex-row justify-between items-center gap-12 px-10 md:px-20 py-10'>
      <article className='md:w-1/2'>
        <img src={FavBookImage} alt="" className='rounded md:w-10/12' />
      </article>

      <article className='md:w-1/2'>
        <h2 className='text-3xl md:text-5xl font-bold my-3 w-[95%] md:w-3/4 leading-snug'>
        ...
        <div className='flex flex-col md:flex-row justify-between gap-6 md:w-3/4 my-5'>
          <div>
